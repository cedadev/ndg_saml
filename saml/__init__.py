...
class Conditions(SAMLObject): 
    ...
    def _setNotOnOrAfter(self, value):
        ...
        is invalid
        '''
        if not isinstance(notOnOrAfter, datetime):
            raise TypeError('Expecting "datetime" type for "notOnOrAfter", '
                            'got %r' % type(value))
        self.__notOnOrAfter = notOnOrAfter  
...
class Issuer(AbstractNameIDType):
    ...
    def __init__(self, 
        ...
        super(Issuer, self).__init__(namespaceURI=namespaceURI,
...
class NameID(AbstractNameIDType):
    ...
    def __init__(self, 
                 ...
                 elementLocalName=DEFAULT_ELEMENT_LOCAL_NAME, 
                 namespacePrefix=SAMLConstants.SAML20_PREFIX):
        super(NameID, self).__init__(namespaceURI=namespaceURI,
                                     elementLocalName=elementLocalName,
                                     namespacePrefix=namespacePrefix)
